...
// }
//
// let programParagraph = `I am enrolled in ${program.name}. It has campuses in ${program.location}. The program lasts ${program.length} and includes lessons on ${program.technology}.`
//
// console.log(programParagraph);
