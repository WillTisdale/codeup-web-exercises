...
//TODO: Create a while Loop that asks the user to confirm: "Would you like to exit?"
...
// do{
//     var otherQuestion = confirm("Would you like to exit");
// } while (!otherQuestion);
...
do{
    var userColor = prompt("What is my favorite color?").toLowerCase()
    if(userColor !== "blue"){
        alert(userColor.toUpperCase() + "! Really?! Try again!")
    } else {
        alert("That's it! Blue is my favorite color!")
    }
